...
const STEPS = {
  ...
  step5: {
    ...
    patterns: [
      { name: 'The Dot', cells: ['G','G','G', 'G','Y','G', 'G','G','G'], note: 'Only center — do algorithm 3x' },
      { name: 'The Line', cells: ['G','G','G', 'Y','Y','Y', 'G','G','G'], note: 'Hold horizontal — do 1x' },
      { name: 'The Boomerang', cells: ['G','Y','G', 'Y','Y','G', 'G','G','G'], note: 'Hold at 9 o\'clock — do 2x' },
      { name: 'The Cross', cells: ['G','Y','G', 'Y','Y','Y', 'G','Y','G'], note: 'Done! Move to step 6' }
    ],
    diagram: {
      face: 'top',
  ...
  step6: {
    ...
    patterns: [
      { name: 'No Corners', cells: ['G','Y','G', 'Y','Y','Y', 'G','Y','G'], note: 'Do algorithm once to get fish' },
      { name: 'The Fish', cells: ['Y','Y','G', 'Y','Y','Y', 'G','Y','G'], note: 'Eye bottom-left, do algorithm' },
      { name: 'All Yellow', cells: ['Y','Y','Y', 'Y','Y','Y', 'Y','Y','Y'], note: 'Done!' }
    ],
    diagram: {
      face: 'top',
